...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button setoutput = (Button) findViewById(R.id.setToOutputBtn);
        Button switchon = (Button) findViewById(R.id.switchOnBtn);
        Button switchoff = (Button) findViewById(R.id.switchOffBtn);
        ...
        scroll = (ScrollView) findViewById(R.id.ctScrollView );
